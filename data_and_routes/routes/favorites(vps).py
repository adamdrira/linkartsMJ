...
function get_current_user(token){
  ...
  const generate_or_get_favorites = (request, response) => {
    ...
    six_months.setDate(six_months.getDate() - 30);
...
list_of_ids=[
    11,31,198,206,240,245,336,354,355,357,379,387,388,389,390,391,392,393,394,395,396,
    2521,2529,2530,2531,2532,2534,2535,2536,2538,
    2611,2613,2615,2624,2625,2628,2630,2638,2641,2643,2658,2662,
    2713,2719,2720,2721,2742,2743,2779,2780,2781,2789,2790,2791,
    2812,2813,2814,2817,2818,2857,2858,2859,2893,2894,
    2900,2901,2912,2913,2914,
    3010,3011,3015,3158,
    3901
  ]
      ...
      pool.query(text,["Artiste",six_months], (error, results) => {
        if (error) {
            ...
            .on("finish", function() {
                ...
                //const pythonProcess = spawn('C:/Users/Utilisateur/AppData/Local/Programs/Python/Python38-32/python',['C:/Users/Utilisateur/AppData/Local/Programs/Pyt>
...
function send_email(){
                  ...
                  /*if(day==1 && parseInt(list_of_rankings[i])<=15){
                    text+=`Vous avez atteint le top 30 des <b>Coups de cœur</b> du jour. Et puisque nous sommes lundi vous allez être rémunéré ! Le montant de cette ré>
                  }
                  else if(parseInt(list_of_rankings[i])>15){
                    text+=`Vous avez atteint le top 30 des <b>Coups de cœur</b> du jour. Continuez ainsi afin d'atteindre le top 15 le prochain lundi et obtenir une ré>
                  }
                  ...
                  let mail_to_send='<div background-color: #f3f2ef;font-family: system-ui,-apple-system,BlinkMacSystemFont,Segoe UI,Roboto,Ubuntu,Helvetica Neue,sans-s>
                  mail_to_send+=`<div style="max-width:550px;margin: 20px auto 0px auto;background:white;border-radius:10px;padding-bottom: 5px;">`;
                    ...
                    <table style="width:100%;margin-bottom:20px">
                        <tr id="tr1">
                            <td align="center" style="padding-top:25px;padding-bottom:15px;text-align:center;">
                                <img src="https://www.linkarts.fr/assets/img/svg/Logo-LA3.svg" height="36" width="36" style="margin:auto auto;height:36px;width:36px;ma>
                            </td>
                        </tr>
                    ...
                    <table style="width:100%;margin:25px auto;">
                      <tr id="tr3">
                          ...
                          <td align="center" style="border-radius: 6px 6px 12px 12px;padding: 20px 20px 26px 20px;background:rgb(240, 240, 240);border-top:3px solid r
                                <p style="text-align: left;color: #6d6d6d;font-size: 14px;font-weight: 600;margin-top: 5px;margin-bottom: 15px;">Félicitation ${list_of_u>
                              <p style="text-align: left;color: #6d6d6d;font-size: 14px;font-weight: 600;margin-top: 5px;margin-bottom: 15px;">${text}</p>
                              <p style="text-align: left;color: #6d6d6d;font-size: 14px;font-weight: 600;margin-top: 5px;margin-bottom: 15px;">Cliquez sur le bouton ci>

                              <div style="margin-top:50px;margin-bottom:35px;-webkit-border-radius: 50px; -moz-border-radius: 50px; border-radius: 5px;">
                                  <a href="https://linkarts.fr/home/favorites" style="color: white ;text-decoration: none;font-size: 16px;margin: 15px auto 15px auto;b>
                              ...
                              <img src="https://www.linkarts.fr/assets/img/svg/Logo-LA3-18-01.svg"  height="40" style="height:40px;max-height: 40px;float: left;margin->
                          </td>
                    ...
                    <table style="width:100%;margin:25px auto;">
                        <tr id="tr4">
                            <td align="center">
                                ...
                                <p style="margin: 10px auto 5px auto;font-size: 13px;color: rgb(32,56,100);max-width: 350px;">LinkArts est un site dédié à la collabora>
                              <a style="margin: 10px auto 0px auto;font-size: 13px;color: rgb(32,56,100);max-width: 350px;" href="https://www.linkarts.fr/account/${lis>
                            </td>
