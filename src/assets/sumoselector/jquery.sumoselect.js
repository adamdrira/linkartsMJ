...
(function(factory) {
    ...
    $.fn.SumoSelect = function(options) {
      ...
      var settings = $.extend({
        ...
        locale: ['OK', 'Annuler', 'Tout sélectionner'], // all text that is used. don't change the index.
        ...
        this.sumo = {
          ...
          add: function(obj, i) {
            ...
            if (obj.grp === "undefined") {
              ...
              //console.log(grp);
              //se non c'Ã¨ il gruppo, lo aggiungo senza gruppo
              if (grp.length == 0) {
                O.E.append(opt);
          ...
          removeAll: function() {
            ...
            for (var x = (options.length - 1); x >= 0; x--) {
              ...
              if (el.parent().is("optgroup")) {
                ...
                //se non ha piÃ¹ figli, tolgo anche quello.
