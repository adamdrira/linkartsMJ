...
def main():
    ...
    #print(file)
    data = pd.read_csv('/home/adamdrira/linkartsMJ//data_and_routes/routes/csvfiles_for_python/classement_python-' +str(headers_content)+'.csv')
    print(data)
    ...
    list_of_views_artpieces_csv.to_json(r'/home/adamdrira/linkartsMJ//data_and_routes/routes/python_files/recommendations_artpieces-'+str(headers_content)+'.json',forc>
    fichier_1 = {'upload_file': open('/home/adamdrira/linkartsMJ//data_and_routes/routes/python_files/recommendations_artpieces-'+str(headers_content)+'.json','rb')}
    ...
    list_of_views_csv.to_json(r'/home/adamdrira/linkartsMJ//data_and_routes/routes/python_files/recommendations-'+str(headers_content)+'.json',force_ascii=False)
    fichier = {'upload_file': open('/home/adamdrira/linkartsMJ//data_and_routes/routes/python_files/recommendations-'+str(headers_content)+'.json','rb')}
