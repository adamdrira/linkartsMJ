...
global.appRoot = __dirname;  //pour testdb
  ...
  app.use(function(req, res, next) {
    ...
    res.setHeader("Access-Control-Allow-Origin", ["https://linkarts.fr","https://www.linkarts.fr"]);
  ...
  const corsOptions = {
    origin: ['https://linkarts.fr',"https://www.linkarts.fr"],
...
app.get('*',(req,res)=>{
    var re = /(?:\.([^.]+))?$/;
    if( req.url.includes(".") && (re.exec(req.url)[1]=="js" || re.exec(req.url)[1]=="map" || re.exec(req.url)[1]=="css" || re.exec(req.url)[1]=="svg" || re.exec(req.ur>
